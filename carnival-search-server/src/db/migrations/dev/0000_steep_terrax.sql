CREATE TYPE "public"."app_type_enum" AS ENUM('google_drive', 'slack', 'jira', 'hubspot', 'gmail', 'github', 'salesforce');--> statement-breakpoint
...
CREATE TABLE "document_chunk" (
	...
	"fk_chunk_connector" uuid NOT NULL,
...
ALTER TABLE "document_chunk" ADD CONSTRAINT "document_chunk_fk_chunk_connector_connector_id_fk" FOREIGN KEY ("fk_chunk_connector") REFERENCES "public"."connector"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
